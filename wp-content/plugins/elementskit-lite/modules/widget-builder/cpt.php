...
class Cpt{
    ...
    public function post_type() {
		...
		$labels = array(
			...
			'menu_name'          => esc_html__( 'My Widgets', 'elementskit' ),
    ...
    public function cpt_menu(){
        ...
        add_submenu_page('elementskit', esc_html__('My Widgets', 'elementskit'), esc_html__('My Widgets', 'elementskit'), 'manage_options', $link_our_new_cpt);
    }
}