...
**Looking for features which not available?  [Request features here](https://trello.com/b/I9RmCP3B/elementskit)**



###Introducing Elements Kit Widget builder.###

The most flexible and super easy to use widget builder with native elementor feel. Build everything in drag and drop interface.
This is now available in free version of elements kit and some pro controls are coming soon.

<iframe width="560" height="315" src="https://www.youtube.com/embed/zE6TMrkZeOI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
- One Page Scroll 
- Advanced Sticky Content  (PRO)
- Advanced Parallax Effects  (PRO)
- Multi Widgets area  (PRO)
- Elementor Gallery Pack. Filterable, Masonry, Grid  (PRO)
- Vertical Mega Menu builder (Pro)
